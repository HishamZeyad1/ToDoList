...
public class ViewtaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            Intent intent = new Intent(ViewtaskActivity.this, Login.class);
    ...
    public void openEdit() {
        ...
        et_task_title.setBackgroundResource(R.drawable.view_content_backgroud);
        et_task_description.setBackgroundResource(R.drawable.view_content_backgroud);
